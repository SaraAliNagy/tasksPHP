...
class User extends config{
    ...
    public function create(){
        $query = "INSERT INTO users (first_name,last_name,email,phone,code,gender,password) VALUES 
        ('$this->first_name' ,'$this->last_name','$this->email','$this->phone','$this->code','$this->gender','$this->password')";

        return $this->runDML($query); //true or false
    }
