...
$specsObj = new Spec();
$specsObj->setId($_GET['id']);

$reviewsObj = new Review();
$reviewsObj->setProducts_id($_GET['id']);

if ($_GET) {
    if (isset($_GET['id'])) {
        if (is_numeric($_GET['id'])) {
            $productsObj->setId($_GET['id']);
            $sherchIdRes = $productsObj->sherchId();
            if ($sherchIdRes) {
                $product = $sherchIdRes->fetch_object();
            } else {
                ...
                <div class="product-details-content">
                    ...
                    <div class="rating-review">
                        ...
                        <div class="pro-dec-review">
                            <ul>
                                <li><?= $product->count_rev ?> Reviews </li>
                    ...
                    <div class="pro-dec-feature">
                        <ul>
                            <?php
                            $specsRes = $specsObj->getSpec();
                            if ($specsRes) {
                                $specs = $specsRes->fetch_all(MYSQLI_ASSOC);
                                foreach ($specs as $key => $spec) {
                                    echo  "<li>{$spec['SPEC']}</li>";
                                }
                            }
                            ?>
                        </ul>
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            ...
                            <li><a href="#"><?= $product->categorie_name_en ?>,</a></li>
                            <li><a href="shop.php?sub=<?= $product->subcategories_id ?>"><?= $product->subcategorie_name_en ?>,</a></li>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="rattings-wrapper">
                        ...
                        <?php
                            ...
                            echo "<div class='alert alert-danger text-center'> NO REVIEWS</div>";
                        }
                        ?>
