...
include_once "app/models/Product_Order.php";

$productsObj = new Product();
$productsObj->setStatus(1);
$productsRes = $productsObj->getMostResent();


$reviewsObj = new Review();
$reviewRes = $reviewsObj->getMostRev();

$productOrderObj = new Product_Order();
$mostOrderRes = $productOrderObj->getMostOrder();
?>
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most Review</h3>
            </div>
        </div>
        <div class="tab-content jump">
            <div class="tab-pane active">
                    ...
                    if ($reviewRes) {
                        ...
                        foreach ($reviews as $key => $review) { ?>
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.php">
                                        <img alt="" src="assets/img/product/<?= $review['image'] ?>">
                                ...
                                <div class="product-content text-left">
                                    <div class="product-hover-style">
                                        <div class="product-title">
                                            <h4>
                                                <a href="product-details.php"><?= $review['name_en'] ?></a>
                                            </h4>
                                        </div>
                                        <div class="cart-hover">
                                            <h4><a href="product-details.php">+ Add to cart</a></h4>
                                    ...
                                    <div class="product-price-wrapper">
                                        <span><?= $review['price'] ?><b> EGP</b></span>
                                    </div>
                                </div>
                            </div>
                    <?php
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Most Order</h3>
            </div>
        </div>
        <div class="tab-content jump">
            <div class="tab-pane active">
                <div class="featured-product-active owl-carousel product-nav">
                    ...
                    if ($mostOrderRes) {
                        $orders = $mostOrderRes->fetch_all(MYSQLI_ASSOC);
                        // print_r($orders);die;
